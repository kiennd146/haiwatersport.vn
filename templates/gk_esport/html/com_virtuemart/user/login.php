...
<div class="order-view">
	<fieldset class="input trackMyOrder">
		<h3><?php echo JText::_('COM_VIRTUEMART_ORDER_ANONYMOUS') ?></h3>
...
?>
<form action="index.php" method="post" name="com-login" class="formLogin">
...
<form action="index.php" method="post" name="login" id="form-login" class="vmlogout">
