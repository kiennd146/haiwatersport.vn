    ...
    */
    ...
    public function generatePadding($block) {
    	...
    	if($block == 'gkContentColumn') { 
    		if($this->modules('left_top + left_bottom + left_left + left_right') && $this->modules('right_top + right_bottom + right_left + right_right')) {
    			return 'gkContentRL';
    		}
    		
    		if($this->modules('left_top + left_bottom + left_left + left_right')) {
    			return 'gkContentL';
    		}
