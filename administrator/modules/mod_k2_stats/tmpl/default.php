<?php
/**
* @version		$Id: default.php 1220 2011-10-18 13:11:26Z joomlaworks $
* @package		K2
...
<?php if($params->get('popularItems')): ?>
...
<?php if($params->get('mostCommentedItems')): ?>
...
<?php if($params->get('latestComments')): ?>
