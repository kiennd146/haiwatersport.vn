...
<div id="k2QuickIconsTitle">
	<a href="index.php?option=com_k2" title="<?php echo JText::_('K2_DASHBOARD'); ?>">
		<span>K2</span>
	</a>
</div>
<?php endif; ?>
...
<div id="k2QuickIcons"<?php if(!$modLogo): ?> class="k2NoLogo"<?php endif; ?>>
  ...
  <?php endif; ?>
	...
	<div style="float:left;">
    <div class="icon">
	    <a href="#" onclick="window.open('http://splashup.com/splashup/','splashupEditor','height=700,width=990,toolbar=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=yes'); return false;">
